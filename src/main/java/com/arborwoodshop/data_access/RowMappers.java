...
class UserMapper implements RowMapper<User> {
    public User mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        user.setSellerStatus(rs.getBoolean("seller_status"));
...
class ListingMapper implements RowMapper<Listing> {
    public Listing mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        listing.setDimensions(rs.getString("dimensions"));
        listing.setCanText(rs.getBoolean("can_text"));
        listing.setPhone(rs.getString("phone"));
        listing.setCanEmail(rs.getBoolean("can_email"));
